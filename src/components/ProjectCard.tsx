...
export default function ProjectCard({
  ...
  return (
    <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 glass-card rounded-md">
      ...
      <div className="z-10 sm:order-1 sm:col-span-2 sm:translate-y-1">
        <img
          ...
          loading="lazy"
          decoding="async"
          className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1 image-glow"
