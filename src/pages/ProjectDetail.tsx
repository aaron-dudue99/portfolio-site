  ...
  if (!project) {
    return (
      <div className="min-h-screen pt-32 px-6 flex flex-col items-center">
        <Link to="/projects" className="mt-8 text-primary underline">
          Return to Projects
        </Link>
      </div>
    );
  ...
  return (
    <article className="pt-32 pb-20 w-full min-h-screen px-6">
      <div className="w-full max-w-[800px] mx-auto">
        <Link
          to="/projects"
          className="inline-flex items-center gap-2 text-[var(--color-text-muted)] hover:text-white transition-colors mb-8 text-sm uppercase tracking-widest font-bold"
        >
